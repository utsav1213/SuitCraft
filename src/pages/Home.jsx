...
const Home = () => {
  ...
  const categories = [
    {
      name: "Cotton",
      image: "https://images.unsplash.com/photo-1544070928-4c3b4c9645eb",
      slug: "cotton",
    },
    {
      name: "Silk",
      image: "https://images.unsplash.com/photo-1604384424869-3f1c4b27f6b7",
      slug: "silk",
    },
    {
      name: "Linen",
    ...
    {
      name: "Velvet",
      image: "https://images.unsplash.com/photo-1589394915729-964714c7c564",
      slug: "velvet",
    },
  ];
  ...
  return (
    <div className="pt-16">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url(https://images.unsplash.com/photo-1543132220-3ec99c6094dc)",
        }}
      >
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          <div className="text-white">
            ...
            <p className="text-xl mb-8">
              Connect with premium fabric sellers and expert tailors
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Explore our curated collection of premium fabrics
              </p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Receive your perfectly tailored suit
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-indigo-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Join SuitCraft today and experience the perfect fit
          </p>
          <button
